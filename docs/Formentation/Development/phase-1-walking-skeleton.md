...
- `Formentation.Definition.Source.Map` (working name): a plain Elixir data source in core, zero dependencies. Reference adapter and cheapest fixture format.
- `Formentation.Definition.Source.JSONSchema`: the JSON Schema adapter for the subset above, with one validator chosen after evaluating [ex_json_schema](https://github.com/jonasschmidt/ex_json_schema) and [JSV](https://github.com/lud/jsv) against the criteria in [[12-ecosystem-and-dependencies#JSON Schema|Ecosystem and dependencies]].
