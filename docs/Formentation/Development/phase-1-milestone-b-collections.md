...
|---|---:|---:|---|---|
| MB-D1 / MB-T1 | [#52](https://github.com/kioopi/formentation/issues/52) | — | ready | MB-D1 decided ([[18-decisions#D-053 — Collections are a dedicated semantic node owning one item template|D-053]]); implementation in the MB-S1 issue |
| MB-D2 / MB-T2 / MB-T3 | [#52](https://github.com/kioopi/formentation/issues/52) | — | ready | MB-D2 decided ([[18-decisions#D-054 — Collection source vocabularies and the degradation table|D-054]]); adapters + differential fixture in the MB-S1 issue |
