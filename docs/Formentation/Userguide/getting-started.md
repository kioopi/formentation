...
- `:map` for `Formentation.Definition.Source.Map` — plain Elixir declarations
- `:json_schema` for `Formentation.Definition.Source.JSONSchema` — JSON Schema 2020-12 documents
