defimpl Phoenix.HTML.FormData, for: Formentation.Form do
  ...
  # never answers :default, so preparation never falls back to
  # used_input?/1), folded once into show_errors? by preparation;
  ...
  # convention; UI implementations read them via preparation's
  # plan.summary.
  ...
  # UI implementation through preparation's plan.summary, which sources non-field
